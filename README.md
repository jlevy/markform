...
- **Form + data in one file** — Schema, current values, and documentation in readable
  Markdown

- **Incremental filling** — Agents or humans fill fields step by step with validation
  feedback

- **Multiple interfaces** — CLI, programmatic API, AI SDK tools, web UI

- **Flexible validation** — Required fields, patterns, ranges, and custom validators
