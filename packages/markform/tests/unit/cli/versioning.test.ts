...
describe("versioning", () => {
  ...
  describe("incrementVersion", () => {
    ...
    it("increments -filled1 to -filled2", () => {
      expect(incrementVersion("form-filled1.form.md")).toBe(
        "form-filled2.form.md"
      );
    });

    it("increments -filled99 to -filled100", () => {
      expect(incrementVersion("form-filled99.form.md")).toBe(
        "form-filled100.form.md"
      );
    });
  ...
  describe("generateVersionedPath", () => {
    ...
    it("returns -filled3 when -filled1 and -filled2 exist", () => {
      mockExistsSync.mockImplementation((path) => {
        return (
          path === "form-filled1.form.md" || path === "form-filled2.form.md"
        );
      });
    ...
    it("increments from existing version", () => {
      ...
      expect(generateVersionedPath("form-filled5.form.md")).toBe(
        "form-filled7.form.md"
      );
    });
