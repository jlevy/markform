...
**Feature Plan:**
[plan-2025-12-27-smart-fence-serialization.txt](plan-2025-12-27-smart-fence-serialization.txt)
...
The automated test suite comprehensively covers the smart fence selection logic.
Manual testing is minimal since this is a serializer-only change with no user-facing CLI
or UI impact.
...
4. **Verify backward compatibility** - The parser already accepts any fence character
   and length, so existing `.form.md` files should continue to work.
   No migration needed.
