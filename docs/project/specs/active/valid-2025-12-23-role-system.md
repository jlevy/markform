...
This is a validation spec for the role system implementation in Markform.
It validates multi-stage form workflows with role-based field ownership and blocking
checkpoints.
...
2. **Example forms updated with roles**
   ...
   - `earnings-analysis.form.md`: key identification fields marked as `role="user"`
...
implemented with UI blocking behavior.
